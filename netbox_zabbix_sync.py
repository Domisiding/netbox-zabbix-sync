...
def main(arguments):
    ...
    if arguments.layout:
        ...
        for hostgroup_item in hg_objects:
            if hostgroup_item not in allowed_objects:
                e = (f"Hostgroup item {hostgroup_item} is not valid. Make sure you"
...
class NetworkDevice:
    ...
    def set_hostgroup(self, formating):
